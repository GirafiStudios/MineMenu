...
public class GuiControlList extends AbstractOptionList<KeyBindingList.Entry> {
    ...
    public class CategoryEntry extends KeyBindingList.Entry {
        ...
        public void render(int p_render_1_, int p_render_2_, int p_render_3_, int p_render_4_, int p_render_5_, int p_render_6_, int p_render_7_, boolean p_render_8_, float p_render_9_) {
            GuiControlList.this.mc.fontRenderer.drawString(this.category, (float)(Objects.requireNonNull(GuiControlList.this.minecraft.currentScreen).width / 2 - this.width / 2), (float)(p_render_2_ + p_render_5_ - GuiControlList.this.mc.fontRenderer.FONT_HEIGHT - 1), 16777215);
        }
